  ...
  return (
    <div className='snap-y snap-mandatory md:ml-[150px] md:p-4'>
      <section className='relative flex flex-col justify-center items-center min-h-screen'>
        <Intro />
        <div className='block w-[100%] md:hidden flex justify-center absolute bottom-0 left-0 right-0 p-4'>
      ...
      <section className='relative flex justify-center items-center min-h-screen' id='skills'>
      <div className='block w-[100%] md:hidden flex justify-center absolute top-0 left-0 right-0 my-2'>
        ...
        <Skills />
        <div className='block w-[100%] md:hidden flex justify-center absolute bottom-0 left-0 right-0 my-2'>
      ...
      <div className='block w-[100%] md:hidden flex justify-center absolute top-0 left-0 right-0 p-2'>
        ...
        <Projects />
        <div className='block w-[100%] md:hidden flex justify-center absolute bottom-0 left-0 right-0 p-2'>
