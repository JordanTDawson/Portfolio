...
export default function Credentials() {
    return (
        <div className='max-w-[80%] text-center'>
            ...
            <a href='https://www.linkedin.com/in/jordantdawson/details/recommendations/' rel='noreferer' target='_blank' className='flex flex-wrap border border-white border-4 p-2 my-4 rounded-xl hover:text-yellow-500 transition-colors hover:scale-105 transform origin-center transition-transform'>
            ...
            <a href='https://learningfuze.com/' rel='noreferer' target='_blank' className='flex flex-wrap border border-white border-4 p-2 my-4 rounded-xl hover:text-yellow-500 transition-colors hover:scale-105 transform origin-center transition-transform'>
                ...
                <div className='m-2 text-left'>
                    <h1 className='text-5xl'>Learning Fuze</h1>
                    <p className='text-gray-500'>Nov 2022 - March 2023</p>
                </div>
                <div className='m-2 text-left text-white'>
                    <ul className='mx-[2rem] list-disc'>
